...
/**
 * Spring Boot 4 自动装配（Spring AI 2.x 线）
 *
 * <p>与 spring-boot3-starter 是配对的两条大版本线：本模块绑定 sdk-spring-ai2
 * （Spring AI 2.x / Boot 4），boot3 starter 绑定 sdk-spring-ai1（Spring AI 1.x /
 * Boot 3）。两代适配器依赖同名坐标 spring-ai-model，一个 classpath 只能存在
 * 一条线，按 Boot 大版本选对 starter 即完成路由。</p>
 *
 ...
 *
 * <p>版本契约：面向 Spring Boot 4.0+ / Spring AI 2.x；Boot 与 Spring AI 的版本
