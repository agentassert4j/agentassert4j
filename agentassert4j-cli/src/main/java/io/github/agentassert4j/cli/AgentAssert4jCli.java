 ...
 * @since 2026-08-27
 */
@Command(name = "agentassert4j", version = "AgentAssert4j 1.0.0-SNAPSHOT", description = "AI Agent 行为回归测试框架 — 基线、重放、裁决", subcommands = {BaselineCommand.class, StatusCommand.class, ReplayCommand.class, ApproveCommand.class, RejectCommand.class, RollbackCommand.class, GraphCommand.class}, mixinStandardHelpOptions = true)
